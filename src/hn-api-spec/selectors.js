...
const DEFAULT_REQ = { timeout: 5 * SECOND, freshness: 30 * MINUTE };
...
{
	return requireResource( requirement, 'newstories' );
}
...
{
	return requireResource( requirement, getResourceName( 'item', id ) );
}
